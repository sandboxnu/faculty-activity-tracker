  ...
  return (
    <div className="flex flex-col items-start h-screen min-w-max bg-white font-bold px-6 py-6 space-y-6 border-r border-black">
      <Link
        href="/dashboard"
        className={`${navClass} ${
          router.pathname == '/dashboard' ? 'border-ruby' : 'hover:border-ruby'
        }`}
      >
        Dashboard
      </Link>
      ...
      {submissionsOpen && (
        <div className="flex flex-col items-start space-y-5 pl-4">
          <Link
            ...
            className={`${navClass} ${
              category == 'teaching' ? 'border-ruby' : 'hover:border-ruby'
            }`}
          >
            Teaching
          </Link>
          <Link
            ...
            className={`${navClass} ${
              category == 'research' ? 'border-ruby' : 'hover:border-ruby'
            }`}
          >
            Research
          </Link>
          <Link
            ...
            className={`${navClass} ${
              category == 'service' ? 'border-ruby' : 'hover:border-ruby'
            }`}
          >
            Service
          </Link>
      ...
      <Link
        href="/profile"
        className={`${navClass} ${
          router.pathname == '/profile' ? 'border-ruby' : 'hover:border-ruby'
        }`}
      >
        My Profile
      </Link>
